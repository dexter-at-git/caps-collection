...
namespace CapsCollection.Desktop.UI.Modules.BulkUpdate.Validators
{
    public class BeerUpdateViewModelValidator : AbstractValidator<BeerUpdateViewModel>
    {
        public BeerUpdateViewModelValidator()
        {
